...
exports.isGitIndex = exports.getGitCreatedTime = exports.checkGit = void 0;
...
const isGitIndex = (filepath) => __awaiter(void 0, void 0, void 0, function* () {
    const { stdout } = yield execa('git', ['ls-files', '--', path_1.basename(filepath)], {
        cwd: path_1.dirname(filepath)
    });
    return stdout.trim() === path_1.basename(filepath);
});
exports.isGitIndex = isGitIndex;
